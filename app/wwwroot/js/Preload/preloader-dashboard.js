function initPreload_Dashboard() {
    ...
    queue.loadFile("/js/Rating/loadContractorInfo.js");
    queue.loadFile("/js/Rating/loadStars.js");
    queue.loadFile("/js/Rating/loadReviewCount.js");
